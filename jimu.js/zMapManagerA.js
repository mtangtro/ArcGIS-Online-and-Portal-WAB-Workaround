  ...
  var instance = null,
    clazz = declare(null, {
	  ...
	  _show2DLayersMap: function(appConfig) {
        ...
        require(['esri/map', "esri/layers/FeatureLayer", "esri/tasks/query"], lang.hitch(this, function(Map, FeatureLayer) {
          var map = new Map(this.mapDivId, 
        {//map options
			extent: new Extent(-8568105.917943126, 4718197.625028494, -8562607.229220716, 4722057.6949569965, new SpatialReference(102100)),
			zoom:17
		});
		  ...
		  var detailedBasemap = new esri.layers.ArcGISTiledMapServiceLayer(
		  "http://maps.umd.edu/arcgis/rest/services/Basemaps/CampusBasemapDetailed/MapServer",{
		  id: "detailed"
		  });
		  
		  map.addLayer(detailedBasemap);
			...
			//like to load from your ArcGIS Server
